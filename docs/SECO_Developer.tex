...
\seco\ lacks of very usable and powerful tool\ --- syntax parser. With parser
you able to input and process any data presented in plain text formats: JSON,
scripts in \emph{any} programming languages

...
\clearpage
\secrel{External Libraries Integration: Syntax Parser}
...
tools: \href{http://www.antlr.org/}{ANTLR} parser toolchain, cell editor able to
use ANTLRed grammars for syntax highlight (and completion?), grammar set for
most used programming and data languages, DLR (Dynamic Language Runtime) for
...
\item \menu{Username>bvsaancr}
\item \menu{Email Address>bvsaancr@sharklasers.com}
\item \menu{Password>*********}
...
\item go to your github account \menu{\url{https://github.com/bvsaancr/}}

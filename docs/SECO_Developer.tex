...
\secrel{Notebook}  
  ...
  Starting \seco\ for first time you can get dialog asking of new neche
  creation. In this case you should select storage directory and niche name.
  If you have no dialog on \seco\ start, look on
\begin{verbatim}
